...
- Tool surface: 176 read-only MCP tools: 169 Yunxiao OpenAPI tools plus 7 enhanced project-management aggregation tools, all registered with MCP read-only annotations and covered by `TestToolsetIncludesBaseReadTools`.
