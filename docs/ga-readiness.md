...
- Tool surface: 175 read-only MCP tools: 169 Yunxiao OpenAPI tools plus 6 enhanced project-management aggregation tools, all registered with MCP read-only annotations and covered by `TestToolsetIncludesBaseReadTools`.
