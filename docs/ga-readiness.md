...
- Tool surface: 170 read-only MCP tools: 169 Yunxiao OpenAPI tools plus 1 enhanced project-management aggregation tool, all registered with MCP read-only annotations and covered by `TestToolsetIncludesBaseReadTools`.
