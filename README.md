...
**Read-only by default, safety first.** 165 of 177 tools are read-only queries. 12 write operations require explicit `read_only=false`.
...
- **Read-only by default**: 165 tools safe for exploration without write access.
