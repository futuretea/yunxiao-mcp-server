...
const BINARY_MAP = {
  darwin_x64: {name: 'yunxiao-mcp-server-darwin-amd64', suffix: ''},
  darwin_arm64: {name: 'yunxiao-mcp-server-darwin-arm64', suffix: ''},
  linux_x64: {name: 'yunxiao-mcp-server-linux-amd64', suffix: ''},
  linux_arm64: {name: 'yunxiao-mcp-server-linux-arm64', suffix: ''},
  win32_x64: {name: 'yunxiao-mcp-server-windows-amd64', suffix: '.exe'},
